...
import { ticketConfigs, words } from "../schema.ts";

export type TicketConfig = typeof ticketConfigs.$inferSelect;
...
export async function getActiveConfig(): Promise<TicketConfig> {
...
export async function getDatabaseWordStats(): Promise<DatabaseWordStats> {
