...
Development milestones for the ELX vocabulary test, organized as sequential stages. Each stage builds on the previous one.
...
- **Stages 3-5** are optional challenge stages users can attempt after the core test.
- **Stage 6** is frozen pending research into automatic semantic distractor generation.
