...
Key architectural decisions for the ELX project. Each decision is recorded as an
...
| [ADR-SESSION-STORE-POSTGRES](ADR-SESSION-STORE-POSTGRES.md) | Session storage: PostgreSQL                            | REQ-SESSION-STATE                              |
...
| [ADR-SESSION-STORE](ADR-SESSION-STORE.md)       | Session storage: Deno KV       | ADR-SESSION-STORE-POSTGRES |
